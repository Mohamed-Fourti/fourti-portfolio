            ...
            <div className="row">
              ...
              <div className="col-12 mt-1">
                <div className="d-flex gap-3 flex-wrap">
                  <a className="button" href="/assets/Mohamed-Fourti-En.pdf" download>
                    <span className="button-text">CV English</span>
                    <span className="button-icon fa fa-download"></span>
                  </a>
                  <a className="button" href="/assets/Mohamed-Fourti-Fr.pdf" download>
                    <span className="button-text">CV Français</span>
                    <span className="button-icon fa fa-download"></span>
                  </a>
                </div>
              </div>
